          ...
          {services.map((service, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative rounded-2xl border border-border bg-surface p-6 sm:p-7 transition-colors hover:border-brand-500/40"
              >
                ...
                <div className="relative flex flex-col gap-4">
                  <div className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-surface-2 border border-border text-brand-400 group-hover:text-brand-300 group-hover:border-brand-500/40 transition-colors">
