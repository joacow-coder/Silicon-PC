    ...
    <section id="presupuesto" className="relative py-20 sm:py-28">
      ...
      <Container className="relative grid grid-cols-1 gap-14 lg:grid-cols-[0.9fr_1.1fr] items-start">
        <SectionHeading
          ...
          title="Contanos qué necesitás, te respondemos por WhatsApp"
        ...
        >
          ...
          <label className="flex flex-col gap-2 text-sm font-medium text-ink">
            ...
            <textarea
              ...
              placeholder="Ej: se me apagó el celular y no enciende más, o quiero cotizar un cargador."
              value={form.message}
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex flex-1 items-center justify-center gap-2 rounded-full bg-brand-500 px-6 py-3.5 text-sm font-semibold text-[#04170c] shadow-[0_0_30px_-6px_var(--color-brand-500)] hover:bg-brand-400 transition-colors"
            >
            ...
            <button
              type="button"
              onClick={handleCopy}
              className="inline-flex items-center justify-center gap-2 rounded-full border border-border px-5 py-3.5 text-sm font-semibold text-ink-muted hover:text-ink hover:border-cyan-glow/40 transition-colors"
            >
